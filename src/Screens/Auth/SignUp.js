...
import { backgd,back_img,logo_blue ,Colors, FontFamily, Sizes } from '../../Constants/Constants';
       ...
       onPress={() => this.onChangeCheck(this.state.isSelected)}
        ...
        />
                        <Text style={s.Text1}>
                            ...
                            <Text style={{fontWeight: "bold",borderColor:'#fff', alignSelf:"center",
                                textDecorationLine:"underline"}}  onPress={()=>this.props.navigation.navigate("Terms_Conditions",{'type':1})}>terms and conditions</Text> and <Text> </Text>
                            <Text style={{fontWeight: "bold",borderBottomColor:'#fff',borderBottomWidth: 1, alignSelf:"center",
                                textDecorationLine:"underline"}}  onPress={()=>this.props.navigation.navigate("Terms_Conditions",{'type':2})}>privacy policy</Text>. 
                        </Text>
                    </View>
...
<TextInput
 ...
 maxLength={1}
 style={{borderWidth:1,borderColor:'#fff',margin:10,padding:8,color:'#fff'}}
 />
...
<View style={{elevation:5}}>
                        <TouchableOpacity style={s.btn1}  onPress={()=>this.VerifyOtp()}>
