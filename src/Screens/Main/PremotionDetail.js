...
render(){
    ...
    return(
        <View>
               ...
               <ImageBackground
                style={{height:300}}
                source={{uri:'https://freshandfine.xyz/app/webservice/images/'+this.state.promotion['image']}}
                imageStyle={s.ImageBackground_Img}
                />
    
            <View style={{backgroundColor:Colors.white,height:500,marginTop:-30,borderRadius:30,padding:10}}> 
                <Text style={{fontSize:18,color:'#000',fontWeight:'bold',marginTop:20}} >Discription :</Text>
                {/* <Text>{this.state.promotion.description}</Text> */}
